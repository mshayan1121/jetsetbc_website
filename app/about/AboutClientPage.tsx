        ...
        <section className="py-24 relative overflow-hidden bg-navy-900 text-white">
            ...
            <div className="container-custom relative z-10 text-center">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-[44px] font-display font-bold text-white mb-16">Award-Winning Service</h2>

                    <div className="grid md:grid-cols-2 gap-8 lg:gap-16 max-w-4xl mx-auto mb-16">
                        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm hover:bg-white/10 transition-colors duration-300">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">Best Business Center of the Year</h3>
                            <p className="text-cream-200/60">Letswork, 2024</p>
                        </div>

                        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm hover:bg-white/10 transition-colors duration-300">
                            <Star className="w-16 h-16 text-gold-400 mx-auto mb-6" />
                            <h3 className="text-xl font-bold text-white mb-2">Best Newcomer of the Year</h3>
                            <p className="text-cream-200/60">Letswork, 2023</p>
                        </div>
                    </div>
                    ...
                    <div className="inline-flex items-center gap-3 bg-white/10 rounded-full px-6 py-3 border border-white/10">
                        ...
                        <span className="text-sm font-medium text-white">4.9/5 Star Rating on Google (162+ Reviews)</span>
                    </div>
                </motion.div>
            </div>
        </section>
