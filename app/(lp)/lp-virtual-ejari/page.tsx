...
import { FileText, Building2, UserCheck, CreditCard, Globe, Shield, MapPin } from "lucide-react";
import type { LucideIcon } from "lucide-react";
import Image from "next/image";
import JetsetForm from "@/components/sections/JetsetForm";

export const metadata: Metadata = {
  title: "Get Your Virtual Ejari Certificate in Dubai | Jetset Business Center",
  description:
    "Official Dubai business address for mainland company formation. Licensed in Business Bay, Prime Tower — from AED 8,500/year.",
  robots: { index: false, follow: false },
  alternates: { canonical: "https://jetsetbc.com/lp-virtual-ejari" },
};
...
const features: { title: string; description: string; Icon: LucideIcon }[] = [
  {
    title: "Virtual Ejari",
    description:
      "Registered tenancy contract with unlimited inspections and same-day processing. Accepted by government authorities and banks.",
    Icon: FileText,
  },
  {
    title: "Company Formation",
    description:
      "Guidance for Mainland and Free Zone licenses. Includes visa processing and corporate bank account opening support.",
    Icon: Building2,
  },
  {
    title: "PRO Services",
    description:
      "Handling of visa processing, Emirates ID, and all government liaison.",
    Icon: UserCheck,
  },
  {
    title: "Bank Account Opening",
    description:
      "Assistance with documentation and introductions to leading UAE banks.",
    Icon: CreditCard,
  },
  {
    title: "VAT & Accounting",
    description:
      "Ongoing compliance support to keep your business running smoothly.",
    Icon: Globe,
  },
  {
    title: "Trademark Registration",
    description:
      "Protecting your intellectual property and brand identity in the UAE.",
    Icon: Shield,
  },
];
...
const whyJetset: { heading: string; body: string }[] = [
  {
    ...
    body: "A prestigious address in the heart of Business Bay, accepted by all UAE government bodies and major banks.",
  },
  {
    heading: "Trusted by 200+ Companies",
    body: "International businesses from tech, consulting, and finance rely on Jetset for their UAE establishment.",
  },
  {
    heading: "Same-Day Processing",
    body: "Virtual Ejari certificates and initial approvals processed on the same working day.",
  },
];

const whoIsThisFor =
  "Entrepreneurs launching a mainland company, freelancers needing a legal Dubai address, or international businesses expanding into the UAE who need an official tenancy contract for licensing, residency visa eligibility, and bank account applications.";

const benefits = [
  "Official Dubai business address for mainland company formation",
  "UAE residency visa eligibility through company registration",
  "Corporate bank account opening support",
  "VAT registration & accounting services included",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="hidden lg:block relative h-[450px] rounded-2xl overflow-hidden">
              <Image
                ...
                alt="Virtual Ejari Services in Dubai"
                fill
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-accent text-sm text-navy-900/70 leading-relaxed">
                      Level 20, Prime Tower, Business Bay, Dubai &bull; Trusted by 200+ International Companies
                    </p>
                  </div>
                </div>
              </div>
